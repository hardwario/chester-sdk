...
static const struct ctr_config_item m_config_items[] = {
	...
	CTR_CONFIG_ITEM_HEX("deveui", m_config_interim.deveui,
			    "DevEUI (format: <16 hexadecimal digits>)", ((const uint8_t[16]){0})),
	CTR_CONFIG_ITEM_HEX("joineui", m_config_interim.joineui,
			    "JoinEUI (format: <16 hexadecimal digits>)", ((const uint8_t[16]){0})),
	CTR_CONFIG_ITEM_HEX("appkey", m_config_interim.appkey,
			    "AppKey (format: <32 hexadecimal digits>)", ((const uint8_t[32]){0})),
	CTR_CONFIG_ITEM_HEX("nwkskey", m_config_interim.nwkskey,
			    "NwkSKey (format: <32 hexadecimal digits>)", ((const uint8_t[32]){0})),
	CTR_CONFIG_ITEM_HEX("appskey", m_config_interim.appskey,
			    "AppSKey (format: <32 hexadecimal digits>)", ((const uint8_t[32]){0})),
};
