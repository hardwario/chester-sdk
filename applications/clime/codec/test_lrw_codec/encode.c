...
// 1-Wire
	...
	g_app_data.rtd_therm.sensor[0].last_sample_temperature = 327.25f;
	g_app_data.rtd_therm.sensor[1].last_sample_temperature = 327.25f;
#if APP_DATA_RTD_THERM_COUNT > 2
	g_app_data.rtd_therm.sensor[2].last_sample_temperature = 327.25f;
	g_app_data.rtd_therm.sensor[3].last_sample_temperature = 327.25f;
#endif

	CTR_TEST_LRW_JSON_RTD_THERMOMETERS(data);
#endif
	...
	g_app_data.tc_therm.sensor[0].last_sample_temperature = 327.25f;
	g_app_data.tc_therm.sensor[1].last_sample_temperature = 327.25f;
#if APP_DATA_TC_THERM_COUNT > 2
	g_app_data.tc_therm.sensor[2].last_sample_temperature = 327.25f;
	g_app_data.tc_therm.sensor[3].last_sample_temperature = 327.25f;
#endif

	CTR_TEST_LRW_JSON_TC_THERMOMETERS(data);
#endif

#if defined(FEATURE_HARDWARE_CHESTER_S1)
	g_app_data.iaq.sensors.last_co2_conc = 12000.f;
	g_app_data.iaq.sensors.last_temperature = 22.25f;
	g_app_data.iaq.sensors.last_humidity = 40.f;
	g_app_data.iaq.sensors.last_illuminance = 12000.f;
	g_app_data.iaq.sensors.last_altitude = 250.f;
	g_app_data.iaq.sensors.last_pressure = 1013.25f;

	// TODO - not implemented yet
	// CTR_TEST_LRW_JSON_IAQ(data);
#endif
...
#if defined(FEATURE_HARDWARE_CHESTER_RTD_A)
	g_app_data.rtd_therm.sensor[0].last_sample_temperature = NAN;
	g_app_data.rtd_therm.sensor[1].last_sample_temperature = NAN;
...
#if defined(FEATURE_HARDWARE_CHESTER_TC_A) || defined(FEATURE_HARDWARE_CHESTER_TC_B)
	g_app_data.tc_therm.sensor[0].last_sample_temperature = NAN;
	g_app_data.tc_therm.sensor[1].last_sample_temperature = NAN;
#if APP_DATA_TC_THERM_COUNT > 2
	g_app_data.tc_therm.sensor[2].last_sample_temperature = NAN;
	g_app_data.tc_therm.sensor[3].last_sample_temperature = NAN;
#endif
