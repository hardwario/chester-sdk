...
const struct ctr_config_item items[] = {
	...
	CTR_CONFIG_ITEM_INT("channel-calib-x0-1", m_config_interim.channel_calib_x0[0], 30, 86400, "Get/Set channel X0 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-x0-2", m_config_interim.channel_calib_x0[1], 30, 86400, "Get/Set channel X0 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-x0-3", m_config_interim.channel_calib_x0[2], 30, 86400, "Get/Set channel X0 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-x0-4", m_config_interim.channel_calib_x0[3], 30, 86400, "Get/Set channel X0 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-x1-1", m_config_interim.channel_calib_x1[0], 30, 86400, "Get/Set channel X1 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-x1-2", m_config_interim.channel_calib_x1[1], 30, 86400, "Get/Set channel X1 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-x1-3", m_config_interim.channel_calib_x1[2], 30, 86400, "Get/Set channel X1 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-x1-4", m_config_interim.channel_calib_x1[3], 30, 86400, "Get/Set channel X1 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-y0-1", m_config_interim.channel_calib_y0[0], 30, 86400, "Get/Set channel Y0 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-y0-2", m_config_interim.channel_calib_y0[1], 30, 86400, "Get/Set channel Y0 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-y0-3", m_config_interim.channel_calib_y0[2], 30, 86400, "Get/Set channel Y0 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-y0-4", m_config_interim.channel_calib_y0[3], 30, 86400, "Get/Set channel Y0 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-y1-1", m_config_interim.channel_calib_y1[0], 30, 86400, "Get/Set channel Y1 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-y1-2", m_config_interim.channel_calib_y1[1], 30, 86400, "Get/Set channel Y1 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-y1-3", m_config_interim.channel_calib_y1[2], 30, 86400, "Get/Set channel Y1 calibration point.", 0),
	CTR_CONFIG_ITEM_INT("channel-calib-y1-4", m_config_interim.channel_calib_y1[3], 30, 86400, "Get/Set channel Y1 calibration point.", 0),
