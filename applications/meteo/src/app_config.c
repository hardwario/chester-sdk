...
#define SETTINGS_PFX "app-chester-meteo"
...
const struct ctr_config_item items[] = {
	...
	CTR_CONFIG_ITEM_BOOL("hygro_t_alarm_hi_report", m_config_interim.hygro_t_alarm_hi_report, "Enable/Disable high temperature alarm.", false),
	CTR_CONFIG_ITEM_BOOL("hygro_t_alarm_lo_report", m_config_interim.hygro_t_alarm_lo_report, "Enable/Disable low temperature alarm.", false),
	CTR_CONFIG_ITEM_FLOAT("hygro_t_alarm_hi_thr", m_config_interim.hygro_t_alarm_hi_thr, -40.0f, 125.0f, "Get/Set high temperature alarm threshold.", 0.0f),
	CTR_CONFIG_ITEM_FLOAT("hygro_t_alarm_hi_hst", m_config_interim.hygro_t_alarm_hi_hst, 0.0f, 100.0f, "Get/Set high temperature alarm hysteresis.", 0.0f),
	CTR_CONFIG_ITEM_FLOAT("hygro_t_alarm_lo_thr", m_config_interim.hygro_t_alarm_lo_thr, -40.0f, 125.0f, "Get/Set low temperature alarm threshold.", 0.0f),
	CTR_CONFIG_ITEM_FLOAT("hygro_t_alarm_lo_hst", m_config_interim.hygro_t_alarm_lo_hst, 0.0f, 100.0f, "Get/Set low temperature alarm hysteresis.", 0.0f),
