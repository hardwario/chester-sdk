...
#define FEATURE_HARDWARE_CHESTER_BAROMETER_TAG  1
#define FEATURE_HARDWARE_CHESTER_METEO_A        1
#define FEATURE_HARDWARE_CHESTER_S2             1
#define FEATURE_SUBSYSTEM_ACCEL                 1
#define FEATURE_SUBSYSTEM_BATT                  1
#define FEATURE_SUBSYSTEM_BLE_TAG               1
#define FEATURE_SUBSYSTEM_BLUETOOTH             1
#define FEATURE_SUBSYSTEM_BT_FILTER_ACCEPT_LIST 1
#define FEATURE_SUBSYSTEM_BT_OBSERVER           1
#define FEATURE_SUBSYSTEM_BUF                   1
#define FEATURE_SUBSYSTEM_BUTTON                1
#define FEATURE_SUBSYSTEM_CBPRINTF_FP_SUPPORT   1
...
#define FEATURE_SUBSYSTEM_FLASH                 1
