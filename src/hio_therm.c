...
static int cmd_therm_init(const struct shell *shell,
...
static int cmd_therm_read(const struct shell *shell,
                          size_t argc, char **argv)
{
    int ret;
...
SHELL_STATIC_SUBCMD_SET_CREATE(
    sub_therm,
    SHELL_CMD_ARG(init, NULL, "Initialize sensor.", cmd_therm_init, 1, 0),
