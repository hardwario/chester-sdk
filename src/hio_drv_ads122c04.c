                               ...
                               uint8_t addr, uint8_t *data)
{
    ...
    ret = hio_bus_i2c_mem_read_8b(ctx->i2c, ctx->dev_addr,
                                  CMD_RREG | addr << 2, data);
                                ...
                                uint8_t addr, uint8_t data)
{
    ...
    ret = hio_bus_i2c_mem_write_8b(ctx->i2c, ctx->dev_addr,
                                   CMD_WREG | addr << 2, data);
